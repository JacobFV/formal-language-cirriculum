"""Lesson 65: ``representation_invention`` — which new predicate compresses the corpus most.
...
from ..._support.ontology import ENTITIES, NEW_PRED_NAMES, REL_NAMES, _description_length, _pattern_instances, _shuffled
