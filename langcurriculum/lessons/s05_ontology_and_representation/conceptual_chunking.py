"""Lesson 67: ``conceptual_chunking`` — the macro that removes the most steps from a plan library.
...
from ..._support.ontology import MACRO_NAMES, OPS, _macro_saving, _shuffled
