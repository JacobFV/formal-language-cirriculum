"""Lesson 61: ``ontology_construction`` — which type hierarchy is consistent with every observation.
...
from ..._support.ontology import _assign_entities, _consistent, _inherited, _label_options, _mutations, _onto_facts, _onto_key, _random_hierarchy, _shuffled
