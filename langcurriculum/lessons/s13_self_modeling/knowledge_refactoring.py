"""Lesson 143: ``knowledge_refactoring`` — reorganize a memory without losing a derivable fact.
...
from ..._support.selfmodel import KINDS, PROPS, _closure, _labels, _rules, _shuffled
