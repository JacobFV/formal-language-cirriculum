"""Lesson 99: ``explanation_repair`` — naming the missing prerequisite from a failure report.
...
from ..._support.epistemics import _concept_graph, _follow, _need, _shuffled
