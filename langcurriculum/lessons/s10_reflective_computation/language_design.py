"""Lesson 117: ``language_design`` — choose the language that expresses a task set in fewest symbols.
...
from ..._support.reflective import _coin_cost, _labels, _nonces, _shuffled
