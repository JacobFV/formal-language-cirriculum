"""Lesson 118: ``dsl_invention`` — which invented DSL makes the recurring computations shortest.
...
from ..._support.reflective import _dsl_cost, _labels, _nonces, _shuffled
