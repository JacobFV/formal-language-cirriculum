"""Lesson 116: ``metalinguistic_reasoning`` — questions about a grammar: grammaticality and ambiguity, by parsing.
...
from ..._support.reflective import _cyk_count, _nonces, _shuffled
