"""Lesson 37: ``question_generation`` — identifying the one missing fact and the question that supplies it.
...
from ..._support.base import COLORS, NAMES
from ..._support.causal import _labels, _nonce_names, _options, _qg_colors
