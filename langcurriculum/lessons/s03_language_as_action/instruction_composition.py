"""Lesson 21: ``instruction_composition`` — sequencing, branching, nested conditions.
...
from ..._support.semantics import _act_sym, _apply, _instruction_query, _rand_action, _world, _world_facts
