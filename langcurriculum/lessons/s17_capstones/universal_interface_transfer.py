"""Lesson 167: ``universal_interface_transfer`` — bootstrap states, actions and reward semantics from a trace, then plan.
...
from ..._support.capstone import _bfs_dist, _nonce_pool, _shuffled
