"""Lesson 125: ``contract_reasoning`` — conditional obligations over an event timeline: active, fulfilled, breached.
...
from ..._support.reflective import _CONTRACT_STATUSES, _contract_status, _nonces, _shuffled
