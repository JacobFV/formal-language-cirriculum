"""Lesson 59: ``general_language_agent`` — a fresh lesson family and answer alphabet every episode.
...
from ..._support.ontology import _OWN_IDS, _STATE, _local_episode, _shuffled
...
def gen_general_language_agent(rng: random.Random):
    ...
    try:
        for _ in range(8):
            ...
            try:
                sub_obs, vocab, ans, sub_hidden = lesson.generate(random.Random(seed))
                again = lesson.generate(random.Random(seed))
