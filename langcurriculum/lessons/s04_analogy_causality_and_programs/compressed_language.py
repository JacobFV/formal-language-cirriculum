"""Lesson 53: ``compressed_language`` — codes, budgets and unique decodability.
...
from ..._support.social import TAGS, _code_ok, _encoded_length, _nonce, _prefix_free, _shuffled
