"""Lesson 46: ``program_synthesis`` — specification by example to a program in a small DSL.
...
from ..._support.causal import _dsl_lists, _dsl_mutate, _dsl_program, _dsl_run, _dsl_symbol, _labels, _options
