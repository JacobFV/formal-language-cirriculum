"""Lesson 60: ``natural_language_bridge`` — an English sentence to the symbolic structure it denotes.
...
from ..._support.ontology import ENTITIES, REL_WORDS, _english, _label_options, _shuffled
