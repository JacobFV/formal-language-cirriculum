"""Lesson 84: ``lemma_invention`` — the intermediate proposition that most shortens a proof.
...
from ..._support.mathematics import _derivation_costs, _horn_theory, _label_items, _ladder_theory, _shuffled
