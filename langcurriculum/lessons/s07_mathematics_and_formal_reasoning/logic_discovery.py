"""Lesson 88: ``logic_discovery`` — inducing which inference rules a world licenses.
...
from ..._support.mathematics import _DISCRIMINATING, _POOL, _REGIMES, _SCHEMAS, _SCHEMA_ATOMS, _fsym, _label_items, _mv_eval, _shuffled
