"""Lesson 89: ``logic_selection`` — choosing the calculus a domain actually obeys.
...
from ..._support.mathematics import _DISCRIMINATING, _REGIMES, _SCHEMAS, _SCHEMA_ATOMS, _VALIDITY, _fsym, _instantiate, _label_items, _matching_schemas, _nonces, _shuffled
