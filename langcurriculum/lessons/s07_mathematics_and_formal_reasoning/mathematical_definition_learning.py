"""Lesson 81: ``mathematical_definition_learning`` — a predicate defined by axioms, then decided.
...
from ..._support.mathematics import _cond_sym, _cond_test, _label_items, _nonce, _rand_cond, _shuffled
