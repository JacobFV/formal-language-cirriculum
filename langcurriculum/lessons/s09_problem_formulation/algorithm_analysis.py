"""Lesson 114: ``algorithm_analysis`` — comparing algorithms by exact executed cost.
...
from ..._support.epistemics import _backward_scan, _binary_search, _forward_scan, _jump_search, _shuffled
