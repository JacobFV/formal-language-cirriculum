"""Lesson 165: ``symbolic_world_builder`` — which generated world actually demands a named capability.
...
from ..._support.capstone import _grammar, _nonce_pool, _productive, _repeated_variable, _self_embedding, _shuffled
